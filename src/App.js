  ...
  return (
    <Paper sx={{ display: "flex", position: "relative", flexDirection: "row", height: "100vh", width: "100vw", backgroundColor: "rgb(15 23 42)", justifyContent: "center" }}>
      <Box
        ...
        sx={{ width: "40%", display: "flex", color: "white", justifyContent: "end", zIndex: 2, overflow: "hidden" }}>
        <Box sx={{ width: "70%", display: "flex", flexDirection: "column", height: "100vh" }}>
          <Box sx={{ height: "9vh" }}></Box>
          <Typography fontSize={50} fontWeight="bolder">Sneha Annamareddy</Typography>
          <Typography fontWeight={700} color='gray' fontSize={25}>Full Stack Engineer</Typography>
      ...
      <Box ref={mainContent} sx={{ width: "60%", height: "100vh", zIndex: 2, overflow: "auto" }}>
        <Box sx={{ width: "80%", display: "flex", flexDirection: "column", color: "white" }}>
          <Box sx={{ height: "10vh" }}></Box>
          <Box ref={about} id="about" sx={{ display: "flex", flexDirection: "column", paddingLeft: "20px", height: "90vh" }}>
            ...
            <Typography fontWeight={250}>
              Currently, I'm a senior frontend engineer at Klaviyo, where I work on the component library team to help maintain and evolve our design system. In this role, I lead accessibility efforts across components, tooling, and patterns.
            </Typography>
            <Box sx={{ display: "flex", justifyContent: "center", alignItems: "center", margin: "auto" }}>
              <img src={profileImage} alt='profileImg' style={{ objectFit: "cover" }} />
            </Box>
          </Box>
          <Box sx={{ height: "5vh" }}></Box>
          <Box ref={experience} id="experience" sx={{ display: "flex", flexDirection: "column", width: "100%" }}>
            <Box mb={2} pl="20px"><Heading img={briefcaseImage} text={"EXPERIENCE"} /></Box>
            <motion.div
            ...
            <motion.div
              ...
              <Experience
                ...
                title="Senior Software Engineer"
                body="Currently, I'm a senior frontend engineer at Klaviyo, where I work on the component library team to help maintain and evolve our design system. In this role, I lead accessibility efforts across components, tooling, and patterns, partnering closely with designers and engineers to ensure accessibility is part of our core architecture."
                skills={["Java", "SringBoot", "JavaScript", "React", "Azure", "Java", "SpringBoot", "JavaScript", "React", "Azure"]}
                company={"Microsoft"}
              />
            </motion.div>
          ...
          <Box ref={skills} id="skills">
            <Box mb={2} pl="20px"><Heading img={toolsImage} text={"SKILLS"} /></Box>

            <Box display="flex" flexDirection="row" width="100%">
              <Skills
                title="Backend Technologies"
                skills={["Java", "SpringBoot", "Python", "Django", "SQL", "NoSQL"]} />

              <Skills
                title="Frontend Technologies"
                skills={["JavaScript", "React", "Redux", "Jest", "Testing Library", "Webpack", "ES6+", "Angular", "TypeScript", "Next.js", "Tailwind CSS", "HTML/CSS"]} />
            </Box>
            ...
            <Box display="flex" flexDirection="row" width="100%">
              ...
              <Skills
                title="Other Skills"
                skills={["Agile Methodologies", "Git", "CI/CD", "Unit Testing", "Microservices Architecture"]} />
            </Box>

            <Box display="flex" flexDirection="row" width="100%">
              <Skills
                title="Soft Skills"
                skills={["Effective Communication", "Team Collaboration", "Problem Solving", "Adaptability", "Time Management"]} />
          ...
          <Box sx={{ height: "10vh" }}></Box>
          <Box ref={projects} id="projects">

          </Box>
          <Box ref={education} height="100vh" id="education">
            <Box mb={2} pl="20px"><Heading img={educationImage} text={"EDUCATION"} /></Box>
            <motion.div
              initial={{ opacity: 0, x: +120 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ amount: 0.6 }} // triggers when 50% visible
      ...
      <div style={{ position: "absolute", width: "100vw", height: "99vh", top: 0, left: 0, zIndex: 1, opacity: 0.3, margin: 0 }} id="particles-js"></div>
    </Paper>
  );
}
